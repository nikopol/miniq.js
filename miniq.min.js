...
JSON.parse(f.responseText)}catch(b){return a.error("json parse error: "+b.message,f)}m(g,f)}else p(f.responseText,f)};f.open(c,d,!0);f.setRequestHeader("Content-Type",r);if(a.headers)for(h in a.headers)f.setRequestHeader(h,a.headers[h]);a.timeout&&(q=setTimeout(function(){f.onreadystatechange=function(){};f.abort();p("timeout",f)},1E3*a.timeout));f.send(g)}return f};k.miniq.prototype=e.fn={each:function(a){var b;for(b=0;b<this.length;++b)a.call(this,this[b]);return this},filter:function(a){var b=
this;return e(b.array.filter(function(c){return a.call(b,c)}))},some:function(a){var b=this;b.array.some(function(c){return a.call(b,c)});return b},nth:function(a){0>a&&(a=this.length+a);return 0>a||a>=this.length?e():e(this[a])},append:function(a){return this.each(function(b){e(a).each(function(a){b.appendChild(a)})})},to:function(a){e(a).append(this);return this},remove:function(){return this.each(function(a){a.parentNode.removeChild(a)})},parent:function(){var a,b,c=[];for(a in this.array)(b=this[a].parentNode)&&
-1==c.indexOf(b)&&c.push(b);return e(c)},children:function(){var a,b=[];for(a in this.array)this[a].childNodes&&(b=b.concat([].slice.call(this[a].childNodes)));return e(b)},html:function(a){return void 0!=a?this.each(function(b){b.innerHTML=a}):this.length?this[0].innerHTML:null},text:function(a){return void 0!=a?this.each(function(b){b.innerHTML=a}):this.length?this[0].innerText||"":null},empty:function(){return this.html("")},val:function(a){return void 0==a?m(this[0]):this.each(function(b){m(b,
a)})},attr:function(a,b){if("object"==typeof a){for(var c in a)this.attr(c,a[c]);return this}if(!1===b)this.each(function(b){b.removeAttribute(a)});else if(void 0==b)return this.length?this[0].getAttribute(a):null;return this.each(function(c){c.setAttribute(a,b)})},clone:function(){var a=[];this.each(function(b){a.push(b.cloneNode(!0))});return e(a)},cls:function(a){if(void 0==a)return this.length?this[0].className:null;var b,c,d,e=/([\+\-\*])([^\+\-\*\s]+)/g;if(/^[\+\-\*]/.test(a))for(;null!==(b=
e.exec(a));)c=b[1],d=b[2],this.each(function(a){var b=a.className.split(/\s+/).filter(function(a){return a});"-"!=c&&-1==b.indexOf(d)?b.push(d):"+"!=c&&(b=b.filter(function(a){return a!=d}));a.className=b.join(" ")});else this.each(function(b){b.className=a});return this},has:function(a){var b=!1;this.some(function(c){return b=c.className.split(" ").some(function(b){return b==a})});return b},css:function(a,b){if(void 0==a)return this.length?this[0].style:null;if("object"==typeof a)this.each(function(b){for(var d in a)b.style[d]=
